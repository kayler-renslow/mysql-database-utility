...
public class MysqlConnection{
	...
	private static final String[] EXECUTE_UPDATE_COLUMN_NAME = {"# of rows edited"};
	 ...
	 * @return MysqlQueryResult containing the results. Returns null if the query failed.
	 ...
	 */
	public MysqlQueryResult query(String sql, QueryType qt) throws QueryFailedException {
	 ...
	 * @throws QueryFailedException     when the query failed. The reason for the fail will be inside the exception's message
	 */
	public MysqlQueryResult query(String sql, boolean updating) throws QueryFailedException {
		if (this.conn == null){
